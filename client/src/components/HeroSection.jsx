...
function HeroSection() {
  return (
    <div className="relative flex flex-col justify-center items-center h-screen w-full">
      ...
      <h1 className="text-white text-6xl md:text-7xl lg:text-8xl mb-4 font-bold mt-[-100px]">SMTG GOOD</h1>
      ...
      <div className="flex flex-col md:flex-row mt-8 space-y-4 md:space-y-0 md:space-x-4">
        <button className="text-white font-bold py-3 px-8 border border-white rounded-full hover:bg-white hover:text-black transition duration-300">
          <a href="/search" target="_blank">GET STARTED</a></button>
        <button className="bg-blue-600 text-white font-bold py-3 px-8 rounded-full hover:bg-blue-500 transition duration-300 flex items-center justify-center">
          LEARN MORE <i className="far fa-play-circle ml-2" /></button>
      </div>
    </div>
  );
}
